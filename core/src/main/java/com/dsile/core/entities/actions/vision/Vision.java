...
abstract public class Vision {
    ...
    public double[] accessSituation(){
        ...
        if (creature.getLogger().isDebugEnabled()) {
            creature.getLogger().debug(creature.toString());
            creature.getLogger().debug("Generation number: {}", creature.getGeneration());
        }

        double[] environment = getEnvironmentByDirection();

        if (creature.getLogger().isDebugEnabled()) {
            creature.getLogger().debug("Sees Food:         Lizards:      Predators:");
            creature.getLogger().debug("{} {} {} | {} {} {} | {} {} {}", environment[0], environment[3], environment[6], environment[1], environment[4], environment[7], environment[2], environment[5], environment[8]);
            creature.getLogger().debug("{} {} {} | {} {} {} | {} {} {}", environment[9], environment[12], environment[15], environment[10], environment[13], environment[16], environment[11], environment[14], environment[17]);
            creature.getLogger().debug("{} {} {} | {} {} {} | {} {} {}", environment[18], environment[21], environment[24], environment[19], environment[22], environment[25], environment[20], environment[23], environment[26]);
        }
        ...
        if (creature.getLogger().isDebugEnabled()) {
            creature.getLogger().debug("Decides:");
            creature.getLogger().debug("Directions: [{}, {}, {}, {}]",  thinks[0], thinks[1], thinks[2], thinks[3]);
            creature.getLogger().debug("Movement:     {}", thinks[4]);
            creature.getLogger().debug("Attack:       {}", thinks[5]);
            creature.getLogger().debug("Eating:       {}", thinks[6]);
            creature.getLogger().debug("Reproduction: {}", thinks[7]);
        }
